...
$(document).ready(function() {
	$("#taulaDades").ripeaDataTable({
		ajaxSourceUrl: "<c:url value="/arxiuUser/${arxiu.id}/expedient/datatable"/>",
...
<body>
	<rip:blocContenidorPath contenidor="${arxiu}"/>
	...
	<table id="taulaDades" class="table table-bordered table-striped" data-rdt-filtre-form-id="expedientFiltreCommand">
		<thead>
			<tr>
				...
				<th data-rdt-property="metaNode.usuariActualWrite" data-rdt-visible="false"></th>
							...
							<ul class="dropdown-menu">
								...
								{{if obert}}
									{{if metaNode_usuariActualWrite}}
										...
										<li><a href="../../arxiuUser/${arxiu.id}/expedient/{{:id}}/agafar" data-rdt-link-confirm="<spring:message code="arxiu.expedient.list.agafar.confirm.1"/> {{:nomPropietariEscriptoriPare}}. <spring:message code="arxiu.expedient.list.agafar.confirm.2"/>" data-rdt-link-ajax="true"><span class="fa fa-unlock"></span>&nbsp;&nbsp;<spring:message code="comu.boto.agafar"/></a></li>
										{{/if}}
									{{/if}}
									{{if codiPropietariEscriptoriPare == '${pageContext.request.userPrincipal.name}'}}
									<li><a href="../../arxiuUser/${arxiu.id}/expedient/{{:id}}/alliberar" data-rdt-link-ajax="true"><span class="fa fa-unlock"></span>&nbsp;&nbsp;<spring:message code="comu.boto.alliberar"/></a></li>
									{{/if}}
								{{/if}}
							</ul>
						</div>
	...
	<a href="<c:url value="/arxiuUser/unitat/${arxiu.unitatCodi}"/>" class="btn btn-default pull-right"><span class="fa fa-arrow-left"></span>&nbsp;<spring:message code="comu.boto.tornar"/></a>
</body>