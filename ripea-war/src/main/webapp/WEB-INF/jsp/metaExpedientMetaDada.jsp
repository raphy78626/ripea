...
$(document).ready(function() {
	$("#taulaDades").ripeaDataTable({
		ajaxSourceUrl: "<c:url value="/metaExpedient/${metaExpedient.id}/metaDada/datatable"/>",
...
<body>
	<table id="taulaDades" class="table table-striped table-bordered" data-rdt-paginable="false" data-rdt-ordenable="true" data-rdt-button-template="tableButtonsTemplate">
		<thead>
			<tr>
				...
				<th data-rdt-property="metaDada.codi"><spring:message code="metaexpedient.metadada.columna.codi"/></th>
				<th data-rdt-property="metaDada.nom"><spring:message code="metaexpedient.metadada.columna.nom"/></th>
				<th data-rdt-property="metaDada.tipus" data-rdt-template="cellMetadadaTipusTemplate">
					<spring:message code="metaexpedient.metadada.columna.tipus"/>
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="../../metaExpedient/${metaExpedient.id}/metaDada/{{:id}}" data-rdt-link-modal="true"><span class="fa fa-pencil"></span>&nbsp;&nbsp;<spring:message code="comu.boto.modificar"/></a></li>
								<li><a href="../../metaExpedient/${metaExpedient.id}/metaDada/{{:id}}/delete" data-rdt-link-ajax="true" data-rdt-link-confirm="<spring:message code="metaexpedient.metadada.confirmacio.esborrar"/>"><span class="fa fa-trash-o"></span>&nbsp;&nbsp;<spring:message code="comu.boto.esborrar"/></a></li>
							</ul>
						</div>
					</script>
				</th>
	...
	<script id="tableButtonsTemplate" type="text/x-jsrender">
		<p style="text-align:right"><a class="btn btn-default" href="../../metaExpedient/${metaExpedient.id}/metaDada/new" data-rdt-link-modal="true"><span class="fa fa-plus"></span>&nbsp;<spring:message code="metaexpedient.metadada.boto.afegir"/></a></p>
	</script>
