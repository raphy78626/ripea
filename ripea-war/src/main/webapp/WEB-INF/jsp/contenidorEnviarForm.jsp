...
<c:set var="titol"><spring:message code="contenidor.enviar.titol"/></c:set>
<html>
<head>
	<title>${titol}</title>
...
<body>
	<form:form action="" class="form-horizontal" commandName="contenidorMoureCopiarEnviarCommand">
		...
		<rip:inputTextarea name="comentariEnviar" textKey="contenidor.enviar.camp.comentari" required="false"/>
