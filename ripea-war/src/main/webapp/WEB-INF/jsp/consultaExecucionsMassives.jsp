...
<head>
	...
	<script type="text/javascript">
		...
		function mostrarContinguts(continguts, exm_id) {
			...
			var html_cont = '<table class="table table-striped table-bordered" id="taula_cont_' + exm_id + '">' + 
								'<thead>' +
									'<tr>' +
			...
			for (var i in continguts) {
				...
				if (contingut.estat == "ESTAT_CANCELAT"){
					estat = "<span class='fa fa-check-circle'></span><label style='padding-left: 10px'><spring:message code='execucions.massives.estat.ESTAT_CANCELAT'/></label>";
				} else if (contingut.estat == "ESTAT_ERROR"){
					estat = "<span class='fa fa-exclamation-circle'></span><label class='msg-error' data-msg-error='" + contingut.error + "' style='cursor: pointer;padding-left: 10px'><spring:message code='execucions.massives.estat.ESTAT_ERROR'/></label>";					
				} else if (contingut.estat == "ESTAT_FINALITZAT"){
					estat = "<span class='fa fa-check-circle'></span><label style='padding-left: 10px'><spring:message code='execucions.massives.estat.ESTAT_FINALITZAT'/></label>";
				} else if (contingut.estat == "ESTAT_PENDENT"){
					estat = "<span class='fa fa-circle-o-notch fa-spin'></span><label style='padding-left: 10px'><spring:message code='execucions.massives.estat.ESTAT_PENDENT'/>";
				}				
...
<div class="panel panel-default">
    <div class="panel-heading" role="tab">
    	<div class="row">
			<div class="col-md-3"><strong><spring:message code="execucions.massives.header.nom"/></strong></div>
			<div class="col-md-2"><strong><spring:message code="execucions.massives.header.execucio"/></strong></div>
			<div class="col-md-1"><strong><spring:message code="execucions.massives.header.error"/></strong></div>
			<div class="col-md-2"><strong><spring:message code="execucions.massives.header.dataInici"/></strong></div>
			<div class="col-md-2"><strong><spring:message code="execucions.massives.header.dataFi"/></strong></div>
			<div class="col-md-2"><strong><spring:message code="execucions.massives.header.usuari"/></strong></div>
		</div>
	</div>
</div>
  ...
  <div class="panel panel-${modebg} linea-exm">
    <div class="panel-heading collapsable" role="tab" id="heading_${exm.id}">
        <a role="button" data-toggle="collapse" href="#collapse_${exm.id}" aria-expanded="true" aria-controls="collapse_${exm.id}">
        	<div class="row">
	        	<div class="col-xs-3">
		          	<spring:message code="execucions.massives.tipus.${exm.tipus}"/>
	          	</div>
