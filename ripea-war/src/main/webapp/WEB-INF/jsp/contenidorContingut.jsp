						...
						<table id="taulaRegistres" class="table table-bordered table-striped" data-rdt-paginable="false">
							<thead>
								<tr>
									...
									<th data-rdt-property="registreTipus" data-rdt-template="cellTipusRegistreTemplate" data-rdt-sortable="false" width="10%">
						...
						<table id="taulaInteressats" class="table table-bordered table-striped" data-rdt-paginable="false" data-rdt-button-template="tableInteressatsButtonsTemplate">
							<thead>
								<tr>
									...
									<th data-rdt-property="representantIdentificador" data-rdt-sortable="false" width="25%"><spring:message code="contenidor.contingut.interessat.columna.representant"/>
<%-- 
