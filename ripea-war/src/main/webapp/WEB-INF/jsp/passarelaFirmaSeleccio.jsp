...
<html>
<head>
	<title><spring:message code="contenidor.document.passarelafirma.seleccio.titol"/></title>
</head>
<body>
	<div class="lead" style="margin-bottom: 10px; text-align: center;">
		<h3><spring:message code="contenidor.document.passarelafirma.seleccio.capsalera"/></h3>
