...
package es.caib.ripea.core.api.service.bantel.wsClient.v2.model;
...
import es.caib.ripea.core.api.service.bantel.wsClient.v2.model.AvisoEntradas;
import es.caib.ripea.core.api.service.bantel.wsClient.v2.model.AvisoEntradasResponse;
import es.caib.ripea.core.api.service.bantel.wsClient.v2.model.BantelFacadeException;
 ...
 * generated in the es.caib.ripea.core.api.service.ws.bantel.v2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Fault_QNAME = new QName("urn:es:caib:bantel:ws:v2:model:BantelFacade", "fault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.ripea.core.api.service.ws.bantel.v2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:es:caib:bantel:ws:v2:model:BantelFacade", name = "fault")
