...
ALTER TABLE IPA_INTERESSAT DROP CONSTRAINT IPA_ENTITAT_INTERESSAT_FK;
ALTER TABLE IPA_INTERESSAT DROP CONSTRAINT IPA_INTERESSAT_MULT_UK;

ALTER TABLE IPA_INTERESSAT DROP (LLINATGES, NIF, ENTITAT_ID);

ALTER TABLE IPA_INTERESSAT ADD CONSTRAINT IPA_INTERESSAT_MULT_UK UNIQUE (EXPEDIENT_ID, DOCUMENT_NUM, NOM, LLINATGE1, LLINATGE2, RAO_SOCIAL, ORGAN_CODI);
