...
ALTER TABLE IPA_CONTENIDOR ADD (
  ...
  CONSTRAINT IPA_CONTENIDOR_MULT_UK UNIQUE (NOM, PARE_ID, TIPUS_CONT, ESBORRAT));
...
ALTER TABLE IPA_REGISTRE ADD (
  ...
  CONSTRAINT IPA_REG_MULT_UK UNIQUE (ENTITAT_ID, ACCIO, TIPUS, ENTITAT_CODI, NUMERO, DATA));

ALTER TABLE IPA_REGISTRE_DOC ADD (
  CONSTRAINT IPA_REG_DOC_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_REG_DOC_MULT_UK  UNIQUE (REGISTRE_ID, IDENTIFICADOR));

ALTER TABLE IPA_REGISTRE_INTER ADD (
  CONSTRAINT IPA_REG_INT_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_REG_INT_MULT_UK UNIQUE (REGISTRE_ID, DOC_TIPUS, DOC_NUM, NOM, LLINATGE1, LLINATGE2, RAO_SOCIAL));
...
ALTER TABLE IPA_REGISTRE_DOC ADD (
  CONSTRAINT IPA_USUCRE_REGDOC_FK FOREIGN KEY (CREATEDBY_CODI) 
    REFERENCES IPA_USUARI (CODI),
  CONSTRAINT IPA_REGISTRE_REGDOC_FK FOREIGN KEY (REGISTRE_ID) 
    REFERENCES IPA_REGISTRE (ID),
  CONSTRAINT IPA_USUMOD_REGDOC_FK FOREIGN KEY (LASTMODIFIEDBY_CODI) 
    REFERENCES IPA_USUARI (CODI));
...
ALTER TABLE IPA_REGISTRE_MOV ADD (
  CONSTRAINT IPA_REGISTRE_REGMOV_FK FOREIGN KEY (CONTENIDOR_ID) 
    REFERENCES IPA_REGISTRE (ID),
