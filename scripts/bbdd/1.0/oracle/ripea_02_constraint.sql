...
ALTER TABLE IPA_METAEXPEDIENT_ARXIU ADD (
  CONSTRAINT IPA_METAEXPARX_PK PRIMARY KEY (METAEXPEDIENT_ID, ARXIU_ID));  
...
ALTER TABLE IPA_DOCUMENT_ENVIAMENT ADD (
  ...
  CONSTRAINT IPA_DOCENV_MULT_UK UNIQUE (EXPEDIENT_ID, DOCUMENT_ID, ASSUMPTE, DATA_ENVIAMENT, DTYPE, TIPUS, DESTIN_DOCTIP, DESTIN_DOCNUM));
...
ALTER TABLE IPA_REGISTRE ADD (
  ...
  CONSTRAINT IPA_REG_MULT_UK UNIQUE (ENTITAT_CODI, LLIBRE_CODI, TIPUS, NUMERO, DATA));

ALTER TABLE IPA_REGISTRE_ANNEX ADD (
  CONSTRAINT IPA_REGANX_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_REGANX_MULT_UK  UNIQUE (REGISTRE_ID, TITOL, FITXER_NOM, FITXER_GESDOC_ID, DATA_CAPTURA, ORIGEN_CIUADM, NTI_TIPUS_DOC));

ALTER TABLE IPA_REGISTRE_INTER ADD (
  CONSTRAINT IPA_REGINT_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_REGINT_MULT_UK UNIQUE (REGISTRE_ID, TIPUS, DOC_TIPUS, DOC_NUM));

ALTER TABLE IPA_REGLA ADD (
  CONSTRAINT IPA_REGLA_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_REGLA_MULT_UK UNIQUE (ENTITAT_ID, NOM, TIPUS, ASSUMPTE_CODI));
...
ALTER TABLE IPA_METAEXPEDIENT_ARXIU ADD (
  CONSTRAINT IPA_ARXIU_METAEXPARX_FK FOREIGN KEY (ARXIU_ID) 
    REFERENCES IPA_ARXIU (ID),
  CONSTRAINT IPA_METAEXP_METAEXPARX_FK FOREIGN KEY (METAEXPEDIENT_ID) 
    REFERENCES IPA_METAEXPEDIENT (ID));
...
ALTER TABLE IPA_ARXIU ADD (
  CONSTRAINT IPA_CONTINGUT_ARXIU_FK FOREIGN KEY (ID) 
...
ALTER TABLE IPA_ESCRIPTORI ADD (
  CONSTRAINT IPA_CONTINGUT_ESCRIPTORI_FK FOREIGN KEY (ID) 
    REFERENCES IPA_CONTINGUT (ID),
...
ALTER TABLE IPA_EXPEDIENT_REL ADD (
  CONSTRAINT IPA_EXPEDIENT_REL_EXP_FK FOREIGN KEY (EXPEDIENT_ID) 
    REFERENCES IPA_EXPEDIENT (ID),
  CONSTRAINT IPA_EXPEDIENT_REL_REL_FK FOREIGN KEY (EXPEDIENT_REL_ID) 
    REFERENCES IPA_EXPEDIENT (ID));
...
ALTER TABLE IPA_BUSTIA ADD (
  CONSTRAINT IPA_CONTINGUT_BUSTIA_FK FOREIGN KEY (ID) 
    REFERENCES IPA_CONTINGUT (ID));

ALTER TABLE IPA_REGISTRE ADD (
  CONSTRAINT IPA_CONTINGUT_REGISTRE_FK FOREIGN KEY (ID) 
    REFERENCES IPA_CONTINGUT (ID),
  CONSTRAINT IPA_REGLA_REGISTRE_FK FOREIGN KEY (REGLA_ID) 
    REFERENCES IPA_REGLA (ID),
...
ALTER TABLE IPA_REGISTRE_INTER ADD (
  ...
  CONSTRAINT IPA_REGISTRE_REGINT_FK FOREIGN KEY (REGISTRE_ID) 
    REFERENCES IPA_REGISTRE (ID),
  CONSTRAINT IPA_REPRESENTANT_REGINT_FK FOREIGN KEY (REPRESENTANT_ID) 
    REFERENCES IPA_REGISTRE_INTER (ID),
  CONSTRAINT IPA_REPRESENTAT_REGINT_FK FOREIGN KEY (REPRESENTAT_ID) 
    REFERENCES IPA_REGISTRE_INTER (ID),
  CONSTRAINT IPA_USUMOD_REGINT_FK FOREIGN KEY (LASTMODIFIEDBY_CODI) 
    REFERENCES IPA_USUARI (CODI));

ALTER TABLE IPA_REGLA ADD (
  CONSTRAINT IPA_ENTITAT_REGLA_FK FOREIGN KEY (ENTITAT_ID) 
    REFERENCES IPA_ENTITAT (ID),
  CONSTRAINT IPA_METAEXPEDIENT_REGLA_FK FOREIGN KEY (METAEXPEDIENT_ID) 
    REFERENCES IPA_METAEXPEDIENT (ID),
  CONSTRAINT IPA_ARXIU_REGLA_FK FOREIGN KEY (ARXIU_ID) 
    REFERENCES IPA_ARXIU (ID),
  CONSTRAINT IPA_BUSTIA_REGLA_FK FOREIGN KEY (BUSTIA_ID) 
    REFERENCES IPA_BUSTIA (ID),
  CONSTRAINT IPA_USUCRE_REGLA_FK FOREIGN KEY (CREATEDBY_CODI) 
    REFERENCES IPA_USUARI (CODI),
  CONSTRAINT IPA_USUMOD_REGLA_FK FOREIGN KEY (LASTMODIFIEDBY_CODI) 
    REFERENCES IPA_USUARI (CODI));
...
ALTER TABLE IPA_CONT_COMMENT ADD (
 ...
 ALTER TABLE IPA_MASSIVA_CONTINGUT ADD (
  ...
  CONSTRAINT IPA_CON_EXMASCON_FK FOREIGN KEY (CONTINGUT_ID) 
    REFERENCES IPA_CONTINGUT (ID),
