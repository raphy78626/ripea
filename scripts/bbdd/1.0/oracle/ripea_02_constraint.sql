...
ALTER TABLE IPA_REGISTRE_ANNEX ADD (
  ...
  CONSTRAINT IPA_REGANX_MULT_UK  UNIQUE (REGISTRE_ID, TITOL, FITXER_NOM, FITXER_GESTDOC_ID, DATA_CAPTURA, ORIGEN_CIUADM, NTI_TIPUS_DOC));
...
ALTER TABLE IPA_REGISTRE ADD (
  CONSTRAINT IPA_CONTINGUT_REGISTRE_FK FOREIGN KEY (ID) 
    REFERENCES IPA_CONTINGUT (ID),
  CONSTRAINT IPA_REGLA_REGISTRE_FK FOREIGN KEY (REGLA_CODI) 
