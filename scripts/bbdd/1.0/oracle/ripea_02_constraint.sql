...
ALTER TABLE IPA_CONT_MOV ADD (
  CONSTRAINT IPA_CONTINGUT_CONTMOV_FK FOREIGN KEY (CONTINGUT_ID) 
    REFERENCES IPA_CONTINGUT (ID),
...
ALTER TABLE IPA_CONT_LOG ADD (
  CONSTRAINT IPA_CONTINGUT_CONTLOG_FK FOREIGN KEY (CONTINGUT_ID) 
    REFERENCES IPA_CONTINGUT (ID),
...
ALTER TABLE IPA_DOCUMENT ADD (
  ...
  CONSTRAINT IPA_EXPEDIENT_DOCUMENT_FK FOREIGN KEY (EXPEDIENT_ID) 
    REFERENCES IPA_EXPEDIENT (ID),
  CONSTRAINT IPA_VERDARRERA_DOCUMENT_FK FOREIGN KEY (VERSIO_DARRERA_ID) 
    REFERENCES IPA_DOCUMENT_VERSIO (ID));
