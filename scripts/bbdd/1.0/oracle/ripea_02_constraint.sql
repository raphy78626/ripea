...
ALTER TABLE IPA_INTERESSAT ADD (
  ...
  CONSTRAINT IPA_INTERESSAT_MULT_UK UNIQUE (NOM, DOCUMENT_NUM, LLINATGE1, LLINATGE2, EXPEDIENT_ID, ORGAN_CODI, RAO_SOCIAL));
...
ALTER TABLE IPA_INTERESSAT ADD (
  ...
  CONSTRAINT IPA_EXPEDIENT_INTERESSAT_FK FOREIGN KEY (EXPEDIENT_ID) 
    REFERENCES IPA_EXPEDIENT (ID));
  CONSTRAINT IPA_INTERESSAT_INTERESSAT_FK FOREIGN KEY (REPRESENTANT_ID) 
