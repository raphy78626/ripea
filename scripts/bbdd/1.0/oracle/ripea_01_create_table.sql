...
(
  ...
  ENV_DATA_PROG        TIMESTAMP(6),
  ENV_TIPUS            VARCHAR2(50)             NOT NULL,
  ...
  DOC_NORMALITZAT      NUMBER(1),
  DOC_GEN_CSV          NUMBER(1)
);
