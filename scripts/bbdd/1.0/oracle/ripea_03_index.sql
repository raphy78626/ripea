...
CREATE INDEX IPA_REGISTRE_REGMOV_FK_I ON IPA_REGISTRE_MOV(REGISTRE_ID); 
CREATE INDEX IPA_ORIGEN_REGMOV_FK_I ON IPA_REGISTRE_MOV(ORIGEN_ID);
CREATE INDEX IPA_DESTI_REGMOV_FK_I ON IPA_REGISTRE_MOV(DESTI_ID);
CREATE INDEX IPA_REMITENT_REGMOV_FK_I ON IPA_REGISTRE_MOV(REMITENT_ID);
CREATE INDEX IPA_USUCRE_REGMOV_FK_I ON IPA_REGISTRE_MOV(CREATEDBY_CODI);
CREATE INDEX IPA_USUMOD_REGMOV_FK_I ON IPA_REGISTRE_MOV(LASTMODIFIEDBY_CODI);
