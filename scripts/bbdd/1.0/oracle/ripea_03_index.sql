...
CREATE INDEX IPA_CONTINGUT_CONTLOG_FK_I ON IPA_CONT_MOV(CONTINGUT_ID);
CREATE INDEX IPA_PARE_CONTLOG_FK_I ON IPA_CONT_MOV(PARE_ID);
CREATE INDEX IPA_CONTMOV_CONTLOG_FK_I ON IPA_CONT_MOV(CONTMOV_ID);
CREATE INDEX IPA_USUCRE_CONTLOG_FK_I ON IPA_CONT_MOV(CREATEDBY_CODI);
CREATE INDEX IPA_USUMOD_CONTLOG_FK_I ON IPA_CONT_MOV(LASTMODIFIEDBY_CODI);
