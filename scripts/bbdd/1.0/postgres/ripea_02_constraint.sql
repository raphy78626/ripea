...
ALTER TABLE ONLY IPA_REGISTRE_ANNEX ADD CONSTRAINT IPA_REGANX_MULT_UK UNIQUE (REGISTRE_ID, TITOL, FITXER_NOM, FITXER_ARXIU_UUID, DATA_CAPTURA, ORIGEN_CIUADM, NTI_TIPUS_DOC);
