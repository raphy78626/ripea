...
(
  ...
  LASTMODIFIEDBY_CODI  character varying(64),
  VERSION              bigint               NOT NULL,
  DOM_TIPUS            character varying(30),
  ...
  DOM_NUM_TIPUS        character varying(30),
  ...
  DOM_VIA_TIPUS        character varying(50)
);
...
(
  ...
  VERSION              bigint                  NOT NULL,
  CADUCITAT            timestamp without time zone,
  EMISOR_DIR3CODI      character varying(9)    NOT NULL,
  ENV_DATA_PROG        timestamp without time zone,
  ENV_TIPUS            character varying(50)   NOT NULL,
  DESTINATARI_NOM      character varying(100),
  DESTINATARI_LLINATGE1 character varying(100),
  DESTINATARI_LLINATGE2 character varying(100),
  DESTINATARI_NIF      character varying(9),
  DESTINATARI_TELEFON  character varying(16),
  DESTINATARI_EMAIL    character varying(100),
  DEH_OBLIGAT          boolean,
  DEH_NIF              character varying(9),
  NOTIFICA_REF         character varying(20),
  SERVEI_TIPUS         character varying(50),
  TITULAR_NOM          character varying(100),
  TITULAR_LLINATGE1    character varying(100),
  TITULAR_LLINATGE2    character varying(100),
  TITULAR_NIF          character varying(9)    NOT NULL,
  TITULAR_TELEFON      character varying(16),
  TITULAR_EMAIL        character varying(100),
  PAGCIE_DIR3          character varying(9),
  PAGCIE_DATA_VIG      timestamp without time zone,
  PAGCOR_DIR3          character varying(9),
  PAGCOR_NUMCONT       character varying(20),
  PAGCOR_CODI_CLIENT   character varying(20),
  PAGCOR_DATA_VIG      timestamp without time zone,
  ...
  RETARD_POSTAL        integer,
  DOC_HASH             character varying(40)   NOT NULL,
  DOC_NORMALITZAT      boolean,
  DOC_GEN_CSV          boolean
);
