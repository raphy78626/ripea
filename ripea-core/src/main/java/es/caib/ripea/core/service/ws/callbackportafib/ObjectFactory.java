 ...
 * generated in the es.caib.portafib.ws.callback.server.v1 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.portafib.ws.callback.server.v1
     * 
     */
