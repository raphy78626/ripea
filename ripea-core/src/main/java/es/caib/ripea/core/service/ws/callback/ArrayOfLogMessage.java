 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://www.indra.es/portafirmasmcgdws/mcgdws}LogMessage" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfLogMessage {
    ...
    protected List<LogMessage> item;
     ...
     * 
     */
    public List<LogMessage> getItem() {
        if (item == null) {
            item = new ArrayList<LogMessage>();
        }
        return this.item;
    }
