...
/**
 * Classe del model de dades que representa una notificació d'un document a un
 * dels interessats d'un expedient.
 * 
...
public class DocumentNotificacioEntity extends DocumentEnviamentEntity {
	...
	public void update(String observacions, DocumentNotificacioTipusEnumDto tipus, String unitatAdministrativa,
			String organCodi, String llibreCodi, String assumpte, Date caducitat, String emisorDir3Codi,
			Date enviamentDataProgramada, NotificacioEnviamentTipusEnum enviamentTipus, String procedimentCodiSia,
	...
	public void updateDestinatari(InteressatDocumentTipusEnumDto destinatariDocumentTipus, String destinatariNom,
			String destinatariLlinatge1, String destinatariLlinatge2, String destinatariNif, String destinatariTelefon,
			String destinatariEmail, boolean destinatariRepresentant, String destinatariPaisCodi,
			String destinatariProvinciaCodi, String destinatariMunicipiCodi) {
	...
	public void updateDeh(boolean dehObligat, String dehNif) {
		this.dehObligat = dehObligat;
		this.dehNif = dehNif;
	}

	public void updateNotifica(String notificaReferencia, ServeiTipusEnum serveiTipus) {
		this.notificaReferencia = notificaReferencia;
		this.serveiTipus = serveiTipus;
	}

	public void updateTitular(String titularNom, String titularLlinatge1, String titularLlinatge2, String titularNif,
			String titularTelefon, String titularEmail) {
	...
	public void updatePagadorCie(String codiDir3, Date dataVigencia) {
		this.pagadorCieCodiDir3 = codiDir3;
		this.pagadorCieDataVigencia = dataVigencia;
	}

	public void updatePagadorCorreus(String codiDir3, String contracteNum, String codiClientFacturacio,
			Date dataVigencia) {
	...
	public void updateSeu(String expedientSerieDocumental, String expedientUnitatOrganitzativa,
			String expedientIdentificadorEni, String expedientTitol, String registreOficina, String registreLlibre,
			InteressatIdiomaEnumDto idioma, String avisTitol, String avisText, String avisTextMobil, String oficiTitol,
			String oficiText) {
	...
	public void updateEnviament(boolean enviamentCountIncrementar, boolean enviamentError,
			String enviamentErrorDescripcio, String registreNumero) {
	...
	public void updateProcessament(boolean processamentCountIncrementar, boolean processamentError,
			String processamentErrorDescripcio, Date dataRecepcio, boolean entregadaORebutjada) {
	...
	public void updateDocument(String documentHash, boolean documentNormalitzat, boolean documentGenerarCsv) {
		this.documentHash = documentHash;
		this.documentNormalitzat = documentNormalitzat;
		this.documentGenerarCsv = documentGenerarCsv;
	}

	public static Builder getBuilder(DocumentNotificacioTipusEnumDto tipus, ExpedientEntity expedient,
			DocumentEnviamentEstatEnumDto estat, String assumpte, Date dataEnviament, DocumentEntity document,
			Date caducitat, String emisorDir3Codi, Date enviamentDataProgramada,
			NotificacioEnviamentTipusEnum enviamentTipus, String procedimentCodiSia, Integer retardPostal) {
		return new Builder(tipus, expedient, estat, assumpte, dataEnviament, document, caducitat, emisorDir3Codi,
				enviamentDataProgramada, enviamentTipus, procedimentCodiSia, retardPostal);
	}

	public static class Builder {
		DocumentNotificacioEntity built;

		Builder(DocumentNotificacioTipusEnumDto tipus, ExpedientEntity expedient, DocumentEnviamentEstatEnumDto estat,
				String assumpte, Date dataEnviament, DocumentEntity document, Date caducitat, String emisorDir3Codi,
				Date enviamentDataProgramada, NotificacioEnviamentTipusEnum enviamentTipus, String procedimentCodiSia,
				Integer retardPostal) {
