 ...
 * generated in the es.caib.portafib.indra.callback.server package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.portafib.indra.callback.server
     * 
     */
