...
public class DownloadOptions  implements java.io.Serializable {
    private es.indra.www.portafirmasws.cws.ModeTypeEnum downloadType;
    ...
    public DownloadOptions(
           es.indra.www.portafirmasws.cws.ModeTypeEnum downloadType,
     ...
     * @return downloadType
     */
    public es.indra.www.portafirmasws.cws.ModeTypeEnum getDownloadType() {
        return downloadType;
    }
     ...
     * @param downloadType
     */
    public void setDownloadType(es.indra.www.portafirmasws.cws.ModeTypeEnum downloadType) {
        this.downloadType = downloadType;
    }
