...
public class Field  implements java.io.Serializable {
    private es.indra.www.portafirmasws.cws.CriteriaEnum name;

    private es.indra.www.portafirmasws.cws.ConditionEnum condition;
    ...
    public Field(
           es.indra.www.portafirmasws.cws.CriteriaEnum name,
           es.indra.www.portafirmasws.cws.ConditionEnum condition,
     ...
     * @return name
     */
    public es.indra.www.portafirmasws.cws.CriteriaEnum getName() {
        return name;
    }
     ...
     * @param name
     */
    public void setName(es.indra.www.portafirmasws.cws.CriteriaEnum name) {
        this.name = name;
    }
     ...
     * @return condition
     */
    public es.indra.www.portafirmasws.cws.ConditionEnum getCondition() {
        return condition;
    }
     ...
     * @param condition
     */
    public void setCondition(es.indra.www.portafirmasws.cws.ConditionEnum condition) {
        this.condition = condition;
    }
