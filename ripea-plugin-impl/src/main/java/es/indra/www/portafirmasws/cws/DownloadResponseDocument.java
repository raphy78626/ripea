...
public class DownloadResponseDocument  implements java.io.Serializable {
    ...
    private es.indra.www.portafirmasws.cws.SignatureFile[] signatureFiles;

    private es.indra.www.portafirmasws.cws.VisualFile[] visualFiles;
    ...
    public DownloadResponseDocument(
           ...
           es.indra.www.portafirmasws.cws.SignatureFile[] signatureFiles,
           es.indra.www.portafirmasws.cws.VisualFile[] visualFiles,
     ...
     */
    public es.indra.www.portafirmasws.cws.SignatureFile[] getSignatureFiles() {
        return signatureFiles;
    }
     ...
     */
    public void setSignatureFiles(es.indra.www.portafirmasws.cws.SignatureFile[] signatureFiles) {
        this.signatureFiles = signatureFiles;
    }
     ...
     * @return visualFiles
     */
    public es.indra.www.portafirmasws.cws.VisualFile[] getVisualFiles() {
        return visualFiles;
    }
     ...
     * @param visualFiles
     */
    public void setVisualFiles(es.indra.www.portafirmasws.cws.VisualFile[] visualFiles) {
        this.visualFiles = visualFiles;
    }
