...
public class UploadRequest  implements java.io.Serializable {
    ...
    private es.indra.www.portafirmasws.cws.UploadRequestDocument document;
    ...
    public UploadRequest(
           ...
           es.indra.www.portafirmasws.cws.UploadRequestDocument document,
    ...
    /**
     * Gets the application value for this UploadRequest.
     * 
     * @return application
     */
    ...
    /**
     * Sets the application value for this UploadRequest.
     * 
     * @param application
     */
    ...
    /**
     * Gets the document value for this UploadRequest.
     * 
     * @return document
     */
    public es.indra.www.portafirmasws.cws.UploadRequestDocument getDocument() {
        return document;
    }


    /**
     * Sets the document value for this UploadRequest.
     * 
     * @param document
     */
    public void setDocument(es.indra.www.portafirmasws.cws.UploadRequestDocument document) {
        this.document = document;
    }


    /**
     * Gets the version value for this UploadRequest.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this UploadRequest.
     * 
     * @param version
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.indra.es/portafirmasws/cws", ">upload-request"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.indra.es/portafirmasws/cws", "UploadRequestDocument"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
