...
public class TypeEnum implements java.io.Serializable {
    ...
    public static final TypeEnum document = new TypeEnum(_document);
    public static final TypeEnum annex = new TypeEnum(_annex);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.indra.es/portafirmasws/cws", "TypeEnum"));
    }
    /**
